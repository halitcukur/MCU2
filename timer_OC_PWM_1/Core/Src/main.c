...
int main(void)
{
	...
	while(1)
	{
		...
		{
			__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, i);
			HAL_Delay(1);
		}
...
void TIMER2_Init(void)
{
	...
	htimer2.Init.Prescaler = 49;		// 1 MHz 1 us
	htimer2.Init.CounterMode = TIM_COUNTERMODE_UP;
	htimer2.Init.Period = 1E6 - 1;		// 1 s
...
void TIMER4_Init(void)
{
	...
	htimer4.Init.Prescaler = 49;		// 1 MHz 1 us
	htimer4.Init.CounterMode = TIM_COUNTERMODE_UP;
	htimer4.Init.Period = 1000 - 1;		// 1 ms
